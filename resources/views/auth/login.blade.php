...
<body class="text-center" cz-shortcut-listen="true">
            ...
            <form class="form-signin" method="POST" action="{{ route('login.post') }}">
                ...
                <input type="email" id="inputEmail" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="Addresse Email" required autofocus>
                @error('email')
                ...
                <input type="password" id="inputPassword" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="Mot de passe" required>
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
